...
StyledRect {
    ...
    ColumnLayout {
        ...
        WrappedLoader {
            ...
            sourceComponent: MaterialIcon {
                animate: true
                text: Nmcli.displayWifiActive ? Icons.getNetworkIcon(Nmcli.displayWifiStrength) : "wifi_off"
                color: root.colour
            }
        }
        ...
        WrappedLoader {
            ...
            sourceComponent: ColumnLayout {
                ...
                Repeater {
                    model: ScriptModel {
                        values: root.bluetoothDevices().filter(device => device?.state !== BluetoothDeviceState.Disconnected)
                    }
                    ...
                    MaterialIcon {
                        ...
                        SequentialAnimation on opacity {
                            running: device.modelData && device.modelData.state !== BluetoothDeviceState.Connected
                            alwaysRunToEnd: true
